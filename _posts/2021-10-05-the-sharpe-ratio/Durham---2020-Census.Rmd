...
description: |
  2020 Census Data vs Newly Drawn Districts
author:
  - name: Jacob Ford
...
Disclaimer: This is just an exploratory analysis and model. The model will be described in the below section, which I'm sure could be improved upon or entirely redesigned. But the richness of the data and the shift in representative districts is the important piece to focus on. 



## I choose you (gerry)-mander! 

For those who got the joke, thanks for growing up in the 1990's. 
...
```{r}
ggplot() + geom_sf(data=centroids[centroids$PARTY_2019==1], color="red", fill=NA)#+geom_sf(data = nc_3857, colour = "red", fill = NA)+theme_void()
```
