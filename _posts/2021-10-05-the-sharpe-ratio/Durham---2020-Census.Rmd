...
ggplot(test, aes(x=PCT_BLC, y=PARTY_2019)) + geom_point(fill='red') + 
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
boxLabels = c("Hispanic", "White", "Black", "Asian", "Log Median Income")

##2019


df <- data.frame(lables=boxLabels, boxOdds = c(1.0021304779   , 
0.9934778163  , 1.0200081806 ,1.0312674226  ,2.0259539656  ), boxCILow = c(1.0014661525    , 0.9931773600   ,1.0195372923 ,1.0295998976  ,1.9723423285   ), 
                        boxCIHigh = c(1.002793072, 0.993778233, 1.020480101,1.032950946,2.081119204))
