...
ggplot(test, aes(x=PCT_BLC, y=PARTY_2019_var)) + geom_point(fill='red') + 
  ...
  scale_y_continuous(name="Percent Democrat 2019")+ggtitle("2019 Districts")

ggplot(test, aes(x=PCT_BLC, y=PARTY_2021)) + geom_point() + 
  stat_smooth(method="glm", method.args=list(family=binomial(link='logit')), se=FALSE)+theme_minimal()+ scale_x_continuous(name="Percent Black") +
  scale_y_continuous(name="Percent Democrat 2021")+ggtitle("2021 Districts")
...
Predictive fit of model using 2019 congressional districts: 
...
Predictive fit of model using 2021 congressional districts: 
