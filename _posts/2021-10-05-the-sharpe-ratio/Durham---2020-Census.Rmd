...
library("distill")
rename_post_dir("_posts/2021-10-05-the-sharpe-ratio", slug="Racial Targetting in Redistricting ")
```


### Race by Representative

Average US House republican district in North Carolina with the old lines was actually less more white compared to the new lines proposed. May be just a natural reflection of white population declining in certain areas (see above map). . 
...
ggplot(test, aes(x=PCT_BLC, y=PARTY_2019)) + geom_point(color='red') + 
