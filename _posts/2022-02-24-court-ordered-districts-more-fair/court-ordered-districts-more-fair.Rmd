...
blocks_2020_White <- get_decennial(
 ...
 geometry=TRUE,
  ...
  mutate(White=value,
         PctWhite = 100*(value/summary_value)) 
...
blocks_2020_Black <- get_decennial(
 ...
 geometry=TRUE
  ...
  mutate(Black=value,
         PctBlack = 100*(value/summary_value)) 
...
blocks_2020_Asian <- get_decennial(
 ...
 geometry=TRUE
  ...
  mutate(Asian=value,
         PctAsian = 100*(value/summary_value)) 
...
blocks_2020_Hispanic <- get_decennial(
 ...
 geometry=TRUE
  ...
  mutate(Hispanic=value,
         PctHispanic = 100*(value/summary_value)) 
...
temp <- st_transform(blocks_2020, st_crs(congress_2019)) %>% st_make_valid()
...
model_2019_blocks <- glm(Party_2019 ~PctHispanic + PctWhite + PctBlack + PctAsian + Med_income_log ,family=binomial(link='logit'),data=train)
